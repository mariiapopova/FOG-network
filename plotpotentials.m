...
subplot(2,3,3); %for 1st STN neuron
plot(t,vsn(1,:));axis([0 tmax -100 80 ]) 
title('STN');
ylabel('Vm (mV)'); xlabel('Time (msec)');

subplot(2,3,4); %for 1st GPe neuron
plot(t,vge(1,:));axis([0 tmax -100 80 ]) 
title('GPe')
ylabel('Vm (mV)'); xlabel('Time (msec)');

subplot(2,3,5); %for 1st GPi neuron
plot(t,vgi(1,:));axis([0 tmax -100 80 ]) 
title('GPi')
ylabel('Vm (mV)'); xlabel('Time (msec)');

subplot(2,3,6); %for 1st striatum neuron
plot(t,vstr(1,:));axis([0 tmax -100 80 ]) 
title('Striatum')
ylabel('Vm (mV)'); xlabel('Time (msec)');

% subplot(2,3,6); %for 1st SNr neuron
